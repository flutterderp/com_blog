...
if ($this->maxLevelcat != 0 && count($this->items[$this->parent->id]) > 0) :
    ?>
    <div class="com-blog-categories__items">
        <?php foreach ($this->items[$this->parent->id] as $id => $item) : ?>
            <?php if ($this->params->get('show_empty_categories_cat') || $item->numitems || count($item->getChildren())) : ?>
            <div class="com-blog-categories__item">
                <div class="com-blog-categories__item-title-wrapper">
                    <div class="com-blog-categories__item-title">
                ...
                <?php if ($this->params->get('show_subcat_desc_cat') == 1) : ?>
                    <?php if ($item->description) : ?>
                        <div class="com-blog-categories__description category-desc">
                ...
                <?php if (count($item->getChildren()) > 0 && $this->maxLevelcat > 1) : ?>
                    <div class="com-blog-categories__children" id="category-<?php echo $item->id; ?>" hidden="">
                    <?php
