...
$wa->useScript('com_blog.articles-list');
...
<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="com-blog-category__articles">
    <?php if ($this->params->get('filter_field') !== 'hide') : ?>
        <div class="com-blog__filter btn-group">
            ...
            <?php else : ?>
                ...
                <input type="text" name="filter-search" id="filter-search" value="<?php echo $this->escape($this->state->get('list.filter')); ?>" class="inputbox" onchange="document.adminForm.submit();" placeholder="<?php echo Text::_('COM_BLOG_' . $this->params->get('filter_field') . '_FILTER_LABEL'); ?>">
            <?php endif; ?>
    ...
    <?php if ($this->params->get('show_pagination_limit')) : ?>
        <div class="com-blog-category__pagination btn-group float-end">
        ...
        <?php if ($this->params->get('show_no_articles', 1)) : ?>
            <div class="alert alert-info">
                <span class="icon-info-circle" aria-hidden="true"></span><span class="visually-hidden"><?php echo Text::_('INFO'); ?></span>
                    <?php echo Text::_('COM_BLOG_NO_ARTICLES'); ?>
            </div>
        <?php endif; ?>
    <?php else : ?>
        <table class="com-blog-category__table category table table-striped table-bordered table-hover">
            ...
            <?php foreach ($this->items as $i => $article) : ?>
                ...
                <th class="list-title" scope="row">
                    ...
                    <?php else : ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <?php if ($article->state == BlogComponent::CONDITION_UNPUBLISHED) : ?>
                        <div>
                ...
                <?php if ($isEditable) : ?>
                    <td class="list-edit">
                        <?php if ($article->params->get('access-edit')) : ?>
                            <?php echo HTMLHelper::_('blogicon.edit', $article, $article->params); ?>
                        <?php endif; ?>
                    </td>
                <?php endif; ?>
                </tr>
    ...
    <?php if (!empty($this->items)) : ?>
        <?php if (($this->params->def('show_pagination', 2) == 1  || ($this->params->get('show_pagination') == 2)) && ($this->pagination->pagesTotal > 1)) : ?>
            <div class="com-blog-category__navigation w-100">
                <?php if ($this->params->def('show_pagination_results', 1)) : ?>
                    <p class="com-blog-category__counter counter float-end pt-3 pe-2">
                        <?php echo $this->pagination->getPagesCounter(); ?>
                    </p>
                <?php endif; ?>
                <div class="com-blog-category__pagination">
