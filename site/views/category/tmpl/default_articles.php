	...
	<table class="category table table-striped table-bordered table-hover">
		...
		<thead>
			<tr>
				...
				<?php endif; ?>
				<?php if ($isEditable) : ?>
					<th id="categorylist_header_edit"><?php echo JText::_('COM_BLOG_EDIT_ITEM'); ?></th>
				<?php endif; ?>
			</tr>
		</thead>
		<?php endif; ?>
				...
				<?php endif; ?>
					<td <?php echo $headerTitle; ?> class="list-title">
						...
						<?php else: ?>
							...
							$link->setVar('return', base64_encode(JRoute::_(BlogHelperRoute::getArticleRoute($article->slug, $article->catid, $article->language), false)));
							?>
