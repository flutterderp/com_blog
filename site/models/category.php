 ...
 * @since  1.5
 */
class BlogModelCategory extends JModelList
{
	/**
	 * Category items data
	 *
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$showSubcategories = $params->get('show_subcategory_blog', '0');

		if ($showSubcategories)
		{
			$this->setState('filter.max_category_levels', $params->get('show_subcategory_blog', '1'));
	...
	public function getItems()
	{
		...
		if ($this->_articles === null && $category = $this->getCategory())
		{
			...
			$model->setState('list.ordering', $this->_buildBlogOrderBy());
