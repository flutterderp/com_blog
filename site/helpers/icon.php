...
abstract class JHtmlIcon
{
	...
	public static function create($category, $params, $attribs = array(), $legacy = false)
	{
		...
		$output = '<span class="hasTooltip" title="' . JHtml::tooltipText('COM_BLOG_CREATE_ARTICLE') . '">' . $button . '</span>';
	...
	public static function edit($article, $params, $attribs = array(), $legacy = false)
	{
		...
		$url = 'index.php?option=com_blog&task=article.edit&a_id=' . $article->id . '&return=' . base64_encode($uri);
		...
		else
		{
			...
			$text = '<span class="hasTooltip icon-' . $icon . ' tip" title="' . JHtml::tooltipText(JText::_('COM_BLOG_EDIT_ITEM'), $overlib, 0, 0)
				. '"></span>'
