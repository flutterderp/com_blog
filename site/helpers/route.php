...
abstract class BlogHelperRoute
{
	 ...
	 *
	 * @param   integer  $id        The route of the blog item.
	...
	public static function getArticleRoute($id, $catid = 0, $language = 0)
	{
		...
		// Create the link
		$link = 'index.php?option=com_blog&view=article&id=' . $id;
	...
	public static function getFormRoute($id)
	{
		...
		if ($id)
		{
			$link = 'index.php?option=com_blog&task=article.edit&a_id=' . $id;
		}
		else
		{
			$link = 'index.php?option=com_blog&task=article.edit&a_id=0';
		}
