 ...
 * @deprecated  4.0
 */
class BlogRouterRulesLegacy implements JComponentRouterRulesInterface
{
	/**
	...
	/**
	 * Preprocess the route for the com_blog component
	 *
	...
	/**
	 * Build the route for the com_blog component
	 *
	 * @param   array  &$query     An array of URL arguments
	...
	public function build(&$query, &$segments)
	{
		...
		// Check again
		if ($menuItemGiven && isset($menuItem) && $menuItem->component != 'com_blog')
		{
			$menuItemGiven = false;
			unset($query['Itemid']);
		}
