...
JLoader::register('BlogHelperRoute', JPATH_ROOT . '/components/com_blog/helpers/route.php');
...
JHtml::_('script', 'com_blog/admin-articles-modal.min.js', array('version' => 'auto', 'relative' => true));
...
<div class="container-popup">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_blog&view=articles&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1&editor=' . $editor); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td>
							<?php $attribs = 'data-function="' . $this->escape($onclick) . '"'
								...
								. ' data-uri="' . $this->escape(BlogHelperRoute::getArticleRoute($item->id, $item->catid, $item->language)) . '"'
