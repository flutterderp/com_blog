...
<form action="<?php echo JRoute::_('index.php?option=com_blog&view=articles'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php else : ?>
					...
					<tr>
						...
						<?php if ($assoc) : ?>
							...
							<th width="5%" class="nowrap hidden-phone">
								<?php echo JHtml::_('searchtools.sort', 'COM_BLOG_HEADING_ASSOCIATION', 'association', $listDirn, $listOrder); ?>
							</th>
						<?php endif; ?>
						<th width="10%" class="nowrap hidden-phone">
						...
						<th width="10%" class="nowrap hidden-phone">
							<?php echo JHtml::_('searchtools.sort', 'COM_BLOG_HEADING_DATE_' . strtoupper($orderingColumn), 'a.' . $orderingColumn, $listDirn, $listOrder); ?>
						</th>
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
						...
						<td class="center">
							<div class="btn-group">
								...
								<?php echo JHtml::_('blogadministrator.featured', $item->featured, $i, $canChange); ?>
						...
						<td class="has-context">
							<div class="pull-left break-word">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_blog&task=article.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
								...
								<div class="small">
									<?php
									$ParentCatUrl = JRoute::_('index.php?option=com_categories&task=category.edit&id=' . $item->parent_category_id . '&extension=com_blog');
									$CurrentCatUrl = JRoute::_('index.php?option=com_categories&task=category.edit&id=' . $item->catid . '&extension=com_blog');
									$EditCatTxt = JText::_('COM_BLOG_EDIT_CATEGORY');
						...
						<td class="hidden-phone">
							<?php if ($item->association) : ?>
								<?php echo JHtml::_('blogadministrator.association', $item->id); ?>
							<?php endif; ?>
						</td>
						<?php endif; ?>
						<td class="small hidden-phone">
			...
			<?php if ($user->authorise('core.create', 'com_blog')
				...
				<?php echo JHtml::_(
					...
					'collapseModal',
					array(
						'title'  => JText::_('COM_BLOG_BATCH_OPTIONS'),
