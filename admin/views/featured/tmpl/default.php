...
<form action="<?php echo JRoute::_('index.php?option=com_blog&view=featured'); ?>" method="post" name="adminForm" id="adminForm">
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td class="has-context">
								<div class="pull-left break-word">
									...
									<?php endif; ?>
									<?php if ($canEdit) : ?>
										<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_blog&task=article.edit&return=featured&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
