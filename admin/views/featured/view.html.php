...
class BlogViewFeatured extends JViewLegacy
{
	...
	{
		BlogHelper::addSubmenu('featured');
	...
	protected function addToolbar()
	{
		...
		$canDo = JHelperContent::getActions('com_blog', 'category', $this->state->get('filter.category_id'));

		JToolbarHelper::title(JText::_('COM_BLOG_FEATURED_TITLE'), 'star featured');
		...
		JToolbarHelper::help('JHELP_BLOG_FEATURED_ARTICLES');
	}
