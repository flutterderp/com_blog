...
class JFormFieldModal_Article extends FormField
{
	...
	protected function getInput()
	{
		...
		// $wa->registerScript('field.modal-fields', 'com_blog/admin-articles-modal.min.js');
		...
		if ($allowEdit)
		{
			$html .= HTMLHelper::_(
				...
				array(
					...
					'modalWidth'  => '80',
					'footer'      => '<button type="button" class="btn btn-secondary"'
							. ' onclick="window.processModalEdit(this, \'' . $this->id . '\', \'edit\', \'article\', \'cancel\', \'item-form\', \'jform_id\', \'jform_name\'); return false;">'
							. Text::_('JLIB_HTML_BEHAVIOR_CLOSE') . '</button>'
							. '<button type="button" class="btn btn-primary"'
							. ' onclick="window.processModalEdit(this, \''
