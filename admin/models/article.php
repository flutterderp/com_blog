 ...
 * @since  1.6
 */
class BlogModelArticle extends JModelAdmin
{
	/**
	...
	protected function cleanupPostBatchCopy(\JTableInterface $table, $newId, $oldId)
	{
		...
		JEventDispatcher::getInstance()->trigger('onContentAfterSave', array('com_blog.article', &$this->table, true, $fieldsData));
	}
	...
	protected function batchMove($value, $pks, $contexts)
	{
		...
		foreach ($pks as $pk)
		{
			...
			$dispatcher->trigger('onContentAfterSave', array('com_blog.article', &$this->table, false, $fieldsData));
		}
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		if ($id = $this->getState('article.id', $id))
		{
			...
			{
				if ($id != 0 && ($user->authorise('core.edit.state', 'com_blog.article.' . (int) $id))
					|| ($id == 0 && !$user->authorise('core.edit.state', 'com_blog')))
				{
	...
	public function featured($pks, $value = 0)
	{
		...
		$table = $this->getTable('Featured', 'BlogTable');
