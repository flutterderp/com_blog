 ...
 * @since  1.5
 */
class ArticleTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
    ...
    public function check()
    {
        ...
        if (!$this->id) {
            ...
            // Gallery can be an empty json string
            if (!isset($this->gallery)) {
                $this->gallery = '{}';
            }

            // Sources can be an empty json string
            if (!isset($this->sources)) {
                $this->sources = '{}';
            }

            // Secondary categories can be an empty string
            if (!isset($this->secondary_categories)) {
                $this->secondary_categories = '';
            }
