...
namespace Joomla\Component\Blog\Administrator\View\Articles;
...
use Joomla\Component\Blog\Administrator\Model\ArticlesModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolbarHelper::title(Text::_('COM_BLOG_ARTICLES_TITLE'), 'copy article');
