...
use Joomla\Component\Blog\Administrator\Model\FeaturedModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolbarHelper::title(Text::_('COM_BLOG_FEATURED_TITLE'), 'star featured');
        ...
        if (!$this->isEmptyState && ($canDo->get('core.edit.state') || \count($this->transitions))) {
            ...
            if (\count($this->transitions)) {
                $childBar->separatorButton('transition-headline', 'COM_BLOG_RUN_TRANSITIONS')
