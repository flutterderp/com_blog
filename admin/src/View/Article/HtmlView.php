...
namespace Joomla\Component\Blog\Administrator\View\Article;
...
use Joomla\Component\Blog\Administrator\Model\ArticleModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->canDo = ContentHelper::getActions('com_blog', 'article', $this->item->id);
        ...
        if ($isNew && (\count($user->getAuthorisedCategories('com_blog', 'core.create')) > 0)) {
            ...
            if (!$isNew) {
                if (ComponentHelper::isEnabled('com_contenthistory') && $this->state->params->get('save_history', 0) && $itemEditable) {
                    $toolbar->versions('com_blog.article', $this->item->id);
                }
