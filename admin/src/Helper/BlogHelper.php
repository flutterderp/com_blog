 ...
 * @since  1.6
 */
class BlogHelper extends \Joomla\CMS\Helper\ContentHelper
{
    /**
    ...
    {
        if ($form->getName() != 'com_categories.categorycom_blog') {
            return;
        }
        ...
        if (
            ...
            || !$component->isWorkflowActive('com_blog.article')
        ) {
        ...
        $query->select($db->quoteName('title'))
            ...
            ->where(
                [
                    ...
                    $db->quoteName('extension') . ' = ' . $db->quote('com_blog.article'),
                ]
            );
