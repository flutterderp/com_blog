...
class ArticleController extends FormController
{
    ...
    protected function postSaveHook(BaseDatabaseModel $model, $validData = [])
    {
        if ($this->getTask() === 'save2menu') {
            ...
            $link = 'index.php?option=com_blog&view=article';
            $type = 'component';
    ...
    protected function allowEdit($data = [], $key = 'id')
    {
        ...
        if ($user->authorise('core.edit', 'com_blog.article.' . $recordId)) {
            return true;
        }

        // Check edit own on the record asset (explicit or inherited)
        if ($user->authorise('core.edit.own', 'com_blog.article.' . $recordId)) {
    ...
    public function batch($model = null)
    {
        ...
        // Set the model
        /** @var \Joomla\Component\Blog\Administrator\Model\ArticleModel $model */
