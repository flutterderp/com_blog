...
class ArticleField extends ModalSelectField
{
    ...
    public function setup(\SimpleXMLElement $element, $value, $group = null)
    {
        ...
        if ($language) {
            ...
            $modalTitle = Text::_('COM_BLOG_SELECT_AN_ARTICLE') . ' &#8212; ' . $this->getTitle();

            $this->dataAttributes['data-language'] = $language;
        } else {
            $modalTitle = Text::_('COM_BLOG_SELECT_AN_ARTICLE');
        }
        ...
        $this->modalTitles['new']     = Text::_('COM_BLOG_NEW_ARTICLE');
        $this->modalTitles['edit']    = Text::_('COM_BLOG_EDIT_ARTICLE');

        $this->hint = $this->hint ?: Text::_('COM_BLOG_SELECT_AN_ARTICLE');
