...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_blog&task=featured.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
                ...
                <?php else : ?>
                    <table class="table itemList" id="articleList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_BLOG_FEATURED_TABLE_CAPTION'); ?>,
