...
use Joomla\Component\Blog\Administrator\Helper\BlogHelper;
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_blog&task=articles.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
if ($workflow_enabled) :
    ...
    ->useScript('com_blog.articles-status');
                ...
                <?php else : ?>
                    <table class="table itemList" id="articleList">
                        ...
                        <?php foreach ($this->items as $i => $item) :
                            ...
                            $canExecuteTransition = $user->authorise('core.execute.transition', 'com_blog.article.' . $item->id);
