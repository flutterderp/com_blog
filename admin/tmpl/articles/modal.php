...
$wa->useScript('core')
    ...
    ->useScript('com_blog.admin-articles-modal');
...
<div class="container-popup">
    ...
    <form action="<?php echo Route::_('index.php?option=com_blog&view=articles&layout=modal&tmpl=component&function=' . $function . '&' . Session::getFormToken() . '=1&editor=' . $editor); ?>" method="post" name="adminForm" id="adminForm">
            ...
            <table class="table table-sm">
                ...
                <?php foreach ($this->items as $i => $item) : ?>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <th scope="row">
                            <?php $attribs = 'data-content-select data-content-type="com_blog.article"'
